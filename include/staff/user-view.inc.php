...
<table width="940" cellpadding="2" cellspacing="0" border="0">
    <tr>
	    ...
	    <!-- wbrmx | 03/01/2016 | START - Adds printing menu -->

	    <span class="action-button">
                <a href="users_print.php?id=<?php echo $user->getId(); ?>"><i class="icon-print"></i> <?php
                    echo __('Bericht'); ?></a>
            </span>

	    <!-- wbrmx | 03/01/2016 | END - Adds printing menu -->
